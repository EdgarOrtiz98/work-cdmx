...
<%
	...
	String strGetDatosCiudadano[][] = null;
	String strFechaHora		=	"";
	String strFechaVen		=	"";
	int k = 0;
	...
	if(strIdSolicitud != null && strIdSolicitud.length() > 0){
		...
		strGetDatosCiudadano = ActualizaCiudadano.getDatosCiudadanoConsulta(strGetSolicitus[0][9]);
	}
%>
...
<TABLE cellspacing="0" cellpadding="0" border="0">
	<TBODY>
		<TR valign="top">
			...
			<TD width="125">
				<a onclick="Imprimir2()"><IMG border="0" src="../Imagenes/Imprimir.gif" width="32"
				height="32"></a>
			</TD>
			<TD width="125">&nbsp;</TD>
			<TD width="125">&nbsp;</TD>
...
<TBODY>
	<TR VALIGN=top>
		...
		<%=strGetDatosCiudadano[0][0]+" "+strGetDatosCiudadano[0][1]+" "+strGetDatosCiudadano[0][2]%>
		</FONT></TD>
		<TD width="286" align="right">&nbsp;</TD>
	</TR>
	<TR VALIGN=top>
...
<TBODY>
	...
	<TR VALIGN=top>
		...
		<td width="251"><FONT SIZE=2 FACE="Verdana"><%=strGetDatosCiudadano[0][11]%></font>
		</td>
		<td width="170"><b><font size="2" color="#004080" face="Arial">Telefono:</font></b>
		</td>
		<td width="163"><FONT SIZE=2 FACE="Verdana"><%=strGetDatosCiudadano[0][10]%></font><br></td>
	</TR>
	<TR valign="top">
		<td width="301">&nbsp;</td>
		<td width="251"><img src="../Imagenes/ecblank.gif" border="0"
	...
	<TR VALIGN=top>
		...
		<td width="251"><FONT SIZE=2 FACE="Verdana"><%=strGetDatosCiudadano[0][5]%></font>
		</td>
		<td width="170"><b><font size="2" color="#004080" face="Arial">Sector:</font></b>
		</td>
		<td width="163"><FONT SIZE=2 FACE="Verdana"><%=strGetDatosCiudadano[0][14]%></font><br></td>
	</TR>
	<TR valign="top">
		<td width="301">&nbsp;</td>
		<td width="251"><img src="../Imagenes/ecblank.gif" border="0"
