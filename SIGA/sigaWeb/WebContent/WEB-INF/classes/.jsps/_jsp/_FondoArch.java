...
public class _FondoArch extends com.orionserver.http.OrionHttpJspPage {
      ...
      out.write(__oracle_jsp_text[7]);
      	...
      	if(strAccion!=null && strAccion.trim().length()>0)
      	{
      		if(strAccion != null && strAccion.equals("guardar"))
      		{
      			...
      			strSisi		=	request.getParameter("sisiNum"); 
      			strInact	=	"2";
      			//strPrefij	=	request.getParameter("pefij");
      			bInsertar1	=	ActualizaExpArchivado.insertarFondo(strCodigo, strSeccion,
      																strFecha, BUsuario.getIdUsuario(),strClave,strSisi, strAux);
      			if(bInsertar1 == 2){
      				//msg ="La clave ya existe";
      				}
      			else{
      				try{
      					//response.sendRedirect("FondoArchview.jsp?msg="+msg);
      		...
      		else if(strAccion != null && strAccion.equals("cambiar"))
      		{
      			...
      			bInsertar1 = ActualizaExpArchivado.actualizaFondo(strsoloDesc,strCodigo, strSeccion, strFecha, 
      															BUsuario.getIdUsuario(), strIdSubfondo,strClave,strSisi,strFecInac,strJustInac,strInact, strAux);
      			if (bInsertar1 != 2){
      				try{
      					//response.sendRedirect("FondoArchview.jsp");
      	...
      	{
      		String strDatosSubfondo[][] = ActualizaExpArchivado.getFondo(strIdSubfondo);
      		...
      		strAux			=  	strClave;
      		ver				=	"si";
      		valida	=	ActualizaExpArchivado.getValidaFondo(strIdSubfondo);
      	}
  ...
  static {
    ...
    "\n".toCharArray();
    __oracle_jsp_text[8] = 
    "\n<META http-equiv=\"Content-Type\" content=\"text/html; charset=ISO-8859-1\">\n<META name=\"GENERATOR\" content=\"IBM Software Development Platform\">\n<META http-equiv=\"Content-Style-Type\" content=\"text/css\">\n<LINK href=\"../theme/Master.css\" rel=\"stylesheet\"\n\ttype=\"text/css\">\n<LINK href=\"../css/calendar.css\" rel=\"stylesheet\"\n\ttype=\"text/css\">\n<LINK href=\"../css/menu.css\" rel=\"stylesheet\"\n\ttype=\"text/css\">\n<script type=\"text/javascript\" src=\"../js/valida.js\"></script>\n<script type=\"text/javascript\" src=\"../js/Menu2.js\"></script>\t\n<SCRIPT language=JavaScript type=text/javascript>\n<!-- \n\tfunction limpiarCampos(){\n\t\tdocument.fondo1AS.reset();\n\t}\n\tfunction rValidando() {\n\t".toCharArray();
    __oracle_jsp_text[9] = 
    "\n\talert(\"Como este registro ya cuenta con registros dependientes, solo podra ser modificado su Descripción \");\n\t".toCharArray();
    __oracle_jsp_text[10] = 
    "\n\t}\n\tfunction habilita()\n\t{\n\t\tif(document.fondo1AS.inactivo.checked == true)\n\t\t{\n\t\tdocument.fondo1AS.justif.disabled = false;\n\t\tdocument.fondo1AS.fecinact.disabled = false;\n\t\t}\n\t\telse\n\t\t{\n\t\tdocument.fondo1AS.justif.disabled = true;\n\t\tdocument.fondo1AS.fecinact.disabled = true;\n\t\t}\n\t}\n\n\tfunction habilita2()\n\t{\n\t\tif(document.fondo1AS.inactivo.checked == true)\n\t\t{\n\t\tdocument.fondo1AS.fecinact.value = \"".toCharArray();
    __oracle_jsp_text[11] = 
    "\";\n\t\tdocument.fondo1AS.fecinact.disabled = false;\n\t\tdocument.fondo1AS.justif.disabled = false;\n\t\t}else\n\t\t{\n\t\tdocument.fondo1AS.fecinact.value = \"\";\n\t\tdocument.fondo1AS.justif.value = \"\";\n\t\tdocument.fondo1AS.fecinact.disabled = true;\n\t\tdocument.fondo1AS.justif.disabled = true;\n\t\t}\n\t}\t\n\t\n\tfunction alfaNumerico(ob){\n\t\tvar ok=false;\n\t\tvar texto=ob.value\n\t\tvar codigo=texto.charCodeAt(texto.length-1);\n\t\tif( (codigo>=48&&codigo<=57)||(codigo>=65&&codigo<=90)||(codigo>=97&&codigo<=122)||(codigo==32)\n\t\t   )\n\t\t\tok=true;\n\t\tif(!ok){\n\t\t\ttexto=texto.substring(0,texto.length-1);\n\t\t\tob.value=texto;\n\t\t}\n\t}\n\t\n\tfunction validaPref()\n\t{\n\t\tpre = document.fondo1AS.clave.value;\n\t\tpre2 = pre.substring(0,2);\n\t\t\tif(pre2!='FO')\n\t\t\t{\n\t\t\tif (eval(pre)==true)\n\t\t\tpre = String(\"1\");\n\t\t\t\tif(pre.length<2)\n\t\t\t\t{\n\t\t\t\tdocument.fondo1AS.clave.value = \"FO0\"+pre;\n\t\t\t\t}else\n\t\t\t\t\t{\n\t\t\t\t\tdocument.fondo1AS.clave.value = \"FO\"+pre;\n\t\t\t\t\t}\n\t\t\t\treturn false;\n\t\t\t}\n\t\tpre3 = document.fondo1AS.clave.value;\n\t\t\tif(pre2=='FO' && pre3.length<3)\n\t\t\t{\n\t\t\t\tdocument.fondo1AS.clave.value = \"FO01\";\n\t\t\t\treturn false;\n\t\t\t}\n\t\t\tif(pre2=='FO' && pre3.length<4)\n\t\t\t{\n\t\t\t\text=pre.substring(2,3);\n\t\t\t\tdocument.fondo1AS.clave.value = \"FO0\"+ext;\n\t\t\t}\n\t}\n\n</SCRIPT>\n<TITLE>Fondo</TITLE>\n<STYLE type=text/css>\n\tBODY {\n\t\tmargin: 0px;\n\t}\n</STYLE>\n</HEAD> \n<BODY background=\"../Imagenes/fondo_claro.jpg\" onload=\"valida=0;rValidando();timer_load();\" \n\tonKeyPress=\"timer_reload();\" \n\tonClick=\"timer_reload();\"\n\tonmousemove=\"limitaTextArea(document.fondo1AS.subSeccion,'Descripción','4000')\">\n<FORM action=\"FondoArch.jsp\" name=\"fondo1AS\" method=\"post\">\n<INPUT type=\"hidden\" value=\"\" name=\"accion\">\n<INPUT type=\"hidden\" value=\"".toCharArray();
    ...
    "\t\n\t\t\t\t<a><img\tsrc=\"../Imagenes/Save.gif\"  alt=\"Guardar\" border=\"0\"\tonclick=\"Guardarfondo()\"></a>\n\t\t\t".toCharArray();
    __oracle_jsp_text[20] = 
    "\n\t\t\t</TD>\n\t\t\t<TD width=\"125\">\n\n\t\t\t</TD>\n\t\t\t<TD width=\"125\">&nbsp;</TD>\n\t\t\t<TD width=\"125\">&nbsp;</TD>\n\t\t\t<TD width=\"125\">&nbsp;</TD>\n\t\t\t<TD width=\"48\"></TD>\n\t\t</TR>\n\t\t<TR valign=\"top\">\n\t\t\t<TD></TD>\n\t\t\t<TD width=\"125\">&nbsp;</TD>\n\t\t\t<TD width=\"125\">&nbsp;<BR>\n\t\t\t</TD>\n\t\t</TR>\n\t</TBODY>\n</TABLE>\n</DIV>\n<DIV class=\"documentBody\" id=\"Body\" style=\"HEIGHT: 441px\">\n<DIV align=\"center\">\n<DIV align=\"center\">\n<TABLE cellspacing=\"0\" cellpadding=\"0\" border=\"0\">\n\t<TBODY>\n\t\t<TR valign=\"top\">\n\t\t\t<TD colspan=\"2\" width=\"206\"><B><FONT face=\"Verdana\" color=\"#00204f\"\n\t\t\t\tsize=\"37777777777\"></FONT><FONT face=\"Verdana\" color=\"#00204f\"\n\t\t\t\tsize=\"2\"><B><FONT size=\"+1\" color=\"#004080\">Fondo</FONT></B></FONT></B></TD>\n\t\t\t<TD width=\"63\">&nbsp;</TD>\n\t\t\t<TD width=\"403\" align=\"right\">&nbsp;&nbsp;**Los datos marcados con negritas son obligatorios</TD>\n\t\t</TR>\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"206\" colspan=\"2\" bgcolor=\"#004080\"></TD>\n\t\t\t<TD width=\"63\" bgcolor=\"#004080\"></TD>\n\t\t\t<TD width=\"403\" align=\"right\" bgcolor=\"#004080\"></TD>\n\t\t</TR>\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"206\" bgcolor=\"#004080\" colspan=\"2\"></TD>\n\t\t\t<TD width=\"63\" bgcolor=\"#004080\"></TD>\n\t\t\t<TD width=\"403\" align=\"right\" bgcolor=\"#004080\"></TD>\n\t\t</TR>\n\t</TBODY>\n</TABLE><TABLE cellspacing=\"0\" cellpadding=\"0\" border=\"0\">\n\t<TBODY>\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"144\"><FONT face=\"Verdana\" size=\"2\">&nbsp;</FONT></TD>\n\t\t\t".toCharArray();
    ...
    "\n\t\t</TR>\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"144\">&nbsp;</TD>\n\t\t\t<TD width=\"528\">&nbsp;</TD>\n\t\t</TR>\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"144\"><FONT face=\"Verdana\" size=\"2\" color=\"#004080\">\n\t\t\t<B>Clave:</B></FONT><BR>\n\t\t\t".toCharArray();
    __oracle_jsp_text[28] = 
    "<B><FONT color=\"red\">*Esta clave ya existe*</FONT> </B>".toCharArray();
    __oracle_jsp_text[29] = 
    "\n\t\t\t</TD>\n\t\t\t<TD width=\"528\">\n\t\t\t\t<INPUT name=\"clave\"  value=\"".toCharArray();
    __oracle_jsp_text[30] = 
    "\" onkeypress = \"AceptaSoloTeclaNumericaYPunto();\" onblur=\"validaPref();\"\n\t\t\t\t\t\t".toCharArray();
    ...
    "\t\t\t\n\t\t\t\ttype=\"text\" maxlength=\"200\" class=\"blue500\">\n\t\t\t</TD>\n\t\t</TR>\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"144\"><FONT color=\"#004080\">&nbsp;</FONT></TD>\n\t\t\t<TD width=\"528\">&nbsp;</TD>\n\t\t</TR>\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"144\"><FONT face=\"Verdana\" size=\"2\" color=\"#004080\">\n\t\t\t<B>Descripción:</B></FONT></TD>\n\t\t\t<TD width=\"528\">\n\t\t\t\t<textarea name=\"subSeccion\" rows=\"8\" cols=\"60\" \n\t\t\t\t\t\t".toCharArray();
    __oracle_jsp_text[40] = 
    "\n\t\t\t\t\t\t\tdisabled=\"disabled\"\n\t\t\t\t\t\t".toCharArray();
    __oracle_jsp_text[41] = 
    "\t\t\t\n\t\t\t\tonKeyDown=\"limitaTextArea(document.fondo1AS.subSeccion,'Descripción','4000')\">".toCharArray();
    __oracle_jsp_text[42] = 
    "</textarea>\n\t\t\t</TD>\n\t\t</TR>\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"144\">&nbsp;</TD>\n\t\t\t<TD width=\"528\">&nbsp;</TD>\n\t\t</TR>\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"144\"><FONT face=\"Verdana\" size=\"2\" color=\"#004080\">\n\t\t\t<B>Años Consulta SISI:</B></FONT></TD>\n\t\t\t<TD width=\"528\">\n\t\t\t\t\t<INPUT name=\"sisiNum\" value=\"".toCharArray();
    __oracle_jsp_text[43] = 
    "\" \n\t\t\t\t\t\t".toCharArray();
    __oracle_jsp_text[44] = 
    "\n\t\t\t\t\t\t\tdisabled=\"disabled\"\n\t\t\t\t\t\t".toCharArray();
    __oracle_jsp_text[45] = 
    "\t\t\t\n\t\t\t\t\tonkeypress = \"AceptaSoloTeclaNumericaYPunto();\" type=\"text\" maxlength=\"1\" class=\"blue100\">\n\t\t\t</TD>\n\t\t</TR>\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"144\">&nbsp;</TD>\n\t\t\t<TD width=\"528\">&nbsp;</TD>\n\t\t</TR>\n\t\t\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"144\"><FONT color=\"#004080\"><FONT face=\"Verdana\" size=\"2\">\n\t\t\tInactivo:</FONT></FONT></TD>\n\t\t\t<TD width=\"528\">\n\t\t\t\t<INPUT type=checkbox onclick=\"habilita2();\" value=\"3\" \n\t\t\t\t\t\t".toCharArray();
