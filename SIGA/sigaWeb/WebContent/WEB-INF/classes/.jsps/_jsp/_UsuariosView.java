...
public class _UsuariosView extends com.orionserver.http.OrionHttpJspPage {
    ...
    try {
      ...
      synchronized (pageContext) {
        if ((BAreaView = (com.meve.sigma.beans.BeanAreaView) pageContext.getAttribute( "BAreaView", PageContext.PAGE_SCOPE)) == null) {
          ...
          out.print(Utilerias.codificaPostHTML(strTmp+"?regIDArea="+strIdArea+"&orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) );
  ...
  static {
    ...
    ">\n\t\t\t<TD width=\"100%\">\n\t\t\t<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n\t\t\t\t<tr>\n\t\t\t\t\t<td width=\"65%\"><INPUT type=checkbox value=\"".toCharArray();
    ...
    "','Asunto_HD'));</script></A>\n\t\t\t\t\t</FONT></td>\n\t\t\t\t\t<td width=\"35%\" align=\"center\"><A onmouseover=\"title='".toCharArray();
