...
public class _EntidadView extends com.orionserver.http.OrionHttpJspPage {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    PageContext pageContext = JspFactory.getDefaultFactory().getPageContext( this, request, response, "../Error/ERError.jsp", true, JspWriter.DEFAULT_BUFFER, true);
    // Note: this is not emitted if the session directive == false
    HttpSession session = pageContext.getSession();
    int __jsp_tag_starteval;
    ServletContext application = pageContext.getServletContext();
    JspWriter out = pageContext.getOut();
    _EntidadView page = this;
    ...
    try {
      ...
      out.print(ActualizaEntidad.getNombreEntidad((String)vTiene.get(i)));
      out.write(__oracle_jsp_text[18]);
      out.print(Utilerias.recortaString(ActualizaEntidad.getNombreEntidad((String)vTiene.get(i)),80));
  ...
  static {
    ...
    "\n<TABLE cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" border=\"0\">\n\t<TBODY>\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"100%\" colspan=\"2\"></TD>\n\t\t</TR>\n</TABLE> \n<TABLE cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" border=\"0\">\n\t<TBODY>\n\t\t<TR>\n\t\t\t<TD width=\"43%\"><A href=\"Entidad.jsp?retURI=".toCharArray();
    __oracle_jsp_text[23] = 
    "\" target=\"_self\"> <IMG\n\t\t\t\theight=\"26\" src=\"../Imagenes/nuevo1.gif\" width=\"27\" border=\"0\" alt=\"Nueva Entidad\"></A> <FONT\n\t\t\t\tface=\"Tahoma\" size=\"2\"> </FONT> <A href=\"javascript:Borrar()\"\n\t\t\t\ttarget=\"_self\"> <IMG border=\"0\" src=\"../Imagenes/borrar1.gif\"\n\t\t\t\twidth=\"30\" height=\"27\" alt=\"Borrar Entidades\"></A></TD>\n\t\t\t<TD width=\"50%\">\n\t\t\t<DIV align=\"right\">\n\t\t\t\t".toCharArray();
