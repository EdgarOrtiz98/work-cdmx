...
<TBODY>
	...
	<TR VALIGN=top>
		...
		<td width="251"><FONT SIZE=2 FACE="Verdana"><%=strDatosCiudadano[0][4]%></font>
		</td>
		<td width="170"><b><font size="2" color="#004080" face="Arial">Telefono:</font></b>
		</td>
		<td width="163"><FONT SIZE=2 FACE="Verdana"><%=strDatosCiudadano[0][11]%></font><br></td>
	</TR>
	<TR valign="top">
		<td width="301">&nbsp;</td>
		<td width="251"><img src="../Imagenes/ecblank.gif" border="0"
	...
	<TR VALIGN=top>
		...
		<td width="251"><FONT SIZE=2 FACE="Verdana"><%=strDatosCiudadano[0][6]%></font>
		</td>
		<td width="170"><b><font size="2" color="#004080" face="Arial">Sector:</font></b>
		</td>
		<td width="163"><FONT SIZE=2 FACE="Verdana"><%=strDatosCiudadano[0][12]%></font><br></td>
	</TR>
	<TR valign="top">
		<td width="301">&nbsp;</td>
		<td width="251"><img src="../Imagenes/ecblank.gif" border="0"
