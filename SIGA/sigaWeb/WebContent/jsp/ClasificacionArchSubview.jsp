...
<TBODY>
	<TR valign="top">
		<TD width="43%">
			...
			<A href="ClasificacionArchSub.jsp?retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>">
				<IMG height="26" title="Agregar SubSerie" src="../Imagenes/nuevo1.gif" width="27" border="0"></A>
				<FONT face="Tahoma" size="2">
				</FONT>
				<A href="javascript:Borrar()">
				<IMG border="0" title="Borrar SubSerie" src="../Imagenes/borrar1.gif" width="30" height="27">
				</A>
		</TD>
...
<TBODY>
	...
	<TR vAlign="middle" <%if(par(t)==true){%><%}else{%>bgcolor="#f6f6f6"<%}%>>
		<TD width="10%">
			...
			<A href="ClasificacionArchSub.jsp?id_sub=<%= campo1 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>" class ="etiquetas" title= "<%=campo3 %>"><%=campo4%></A>
			</FONT>
	   	</TD> 
		<TD width="10%" align="center">
			<FONT face=Arial color=#000080 size=1>
			<A href="ClasificacionArchSub.jsp?id_sub=<%= campo1 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>" class ="etiquetas" title= "<%=campo5 %>"><%=campo6%></A>
			</FONT>
		</TD>
		<TD width="10%" align="center">
			<FONT face=Arial color=#000080 size=1>
			<A href="ClasificacionArchSub.jsp?id_sub=<%= campo1 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>" class ="etiquetas" title= "<%=campo7 %>"><%=campo8%></A>
			</FONT>
		</TD>
		<TD width="10%" align="center">
			<FONT face=Arial color=#000080 size=1>
			<A href="ClasificacionArchSub.jsp?id_sub=<%= campo1 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>" class ="etiquetas" title= "<%=campo9 %>"><%=campo10%></A>
			</FONT>
		</TD>
		<TD width="10%" align="center">
		    <FONT face=Arial color=#000080 size=1>
		    <A href="ClasificacionArchSub.jsp?id_sub=<%= campo1 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>"><%= campo2 %></A>
    		</FONT>
			
		</TD>		
		<TD width="20%" align="center">
			<FONT face=Arial color=#000080 size=1>
			<A title="<%=campo11%>"><script>document.write(trunc('<%=campo11%>','Asunto_HD'));</script> </A>
			</FONT>
		</TD>	
		<TD width="20%" align="center">
			<FONT face=Arial color=#000080 size=1>
			<A title="<%=campo12%>"><script>document.write(trunc('<%=campo12%>','Asunto_HD'));</script></A>
			</FONT>
		</TD>	
		<TD width="10%" align="center">
			<FONT face=Arial color=#000080 size=1>
