...
%>
<%
	boolean bExistenTRem = false; 
	bExistenTRem = ActualizaReportes.getExistenRRemitido(BUsuario.getIdArea());
...
<FORM name="viewRTRemitido" action="ViewAsuntoRemitido.jsp" method="post">
...
<tr valign="top">
	<td width="43%">
		...
		<a href="ReporteRemitido.jsp" title="Genera Reporte">
	...
	<font face="verdana" size="4">Asuntos Remitidos</font>
	</td>
</tr>
</table>
...
<TABLE WIDTH='100%' BORDER=0>
	...
	<TR>
		...
		<%	numRegistros = ActualizaReportes.getReportesPorARemitidos(BUsuario.getIdArea(),strOrden,strTipo).length;
			if (numRegistros>0){ %>
			<!-- &nbsp;&nbsp;&nbsp;&nbsp;
	...
	<%	String[][] sql = ActualizaReportes.getReportesPorARemitidos(BUsuario.getIdArea(),strOrden,strTipo);
	...
	<TR>
		<TD WIDTH='15%' align="center"> 
			...
			<%}%>
			<A href="ReporteRemitido.jsp?id_rep=<%=campo1%>&retURI=<%=com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas)%>">
				<%=campo1%>
			</A>
			</font>
		</TD>
