...
<table border="0" cellspacing="0" cellpadding="0">
	<tr valign="top">
		...
		<td width="108"><a onclick="window.open('../RporTipDocto?id_rep=<%=strIdReporte%>&tip=AnalisisPorAsuntoRemitido&tit=<%=strDatosReportes[0][0]%>');">
			<IMG border="0" src="../Imagenes/ic_pdf.gif" title="Exportar a PDF"></a></td>
		<td width="144"><a onclick="window.open('../ReportExcel?id_rep=<%=strIdReporte%>&tip=AnalisisPorAsuntoRemitidoExcel&tit=<%=strDatosReportes[0][0]%>');">
...
<table border="1">
	<tr valign="top">
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr valign="top">
				<td width="75%"><b><font size="2" color="#FFFFFF" face="Arial"><%=ActualizaArea.NombreArea(BUsuario.getIdArea())%><BR><%=strDatosReportes[0][0]%></font></b>
				</td>
				<td width="25%">
	...
	<TBODY>
		<TR>
			<TD><cewolf:chart id="horizontalBarChart3D"
				title="Grafica por numero de Asuntos Remitidos" type="horizontalBar3D"
				xaxislabel="Control de Folio" yaxislabel="Totales">
		...
		<TR>
			<TD><cewolf:chart id="pieChart"
				title="Grafica de porcentaje por Asuntos Remitidos" type="pie">
				<cewolf:gradientpaint>
					<cewolf:point x="0" y="0" color="#FFFFFF" />
					<cewolf:point x="300" y="0" color="#DDDDFF" />
				</cewolf:gradientpaint>
