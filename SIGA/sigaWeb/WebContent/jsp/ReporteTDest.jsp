...
<table border="0" cellspacing="0" cellpadding="0">
	<tr valign="top">
		...
		<td width="108"><a onclick="window.open('../RporTipDocto?id_rep=<%=strIdReporte%>&tip=AnalisisPorDestinatario&tit=<%=strDatosReportes[0][0]%>');">
			<IMG border="0" src="../Imagenes/ic_pdf.gif" title="Exportar a PDF"></a></td>
		<td width="144"><a onclick="window.open('../ReportExcel?id_rep=<%=strIdReporte%>&tip=AnalisisPorDestinatarioExcel&tit=<%=strDatosReportes[0][0]%>');">
...
<table border="0" cellspacing="0" cellpadding="0">
	<TR>
			<TD><cewolf:chart id="horizontalBarChart3D"
				title="Grafica por No. Asuntos por Ventanilla" type="horizontalBar3D"
				xaxislabel="Ventanilla" yaxislabel="Totales">
		...
		<TR>
			<TD><cewolf:chart id="pieChart"
				title="Grafica de Porcentaje de Asuntos por Ventanilla" type="pie">
				<cewolf:gradientpaint>
					<cewolf:point x="0" y="0" color="#FFFFFF" />
					<cewolf:point x="300" y="0" color="#DDDDFF" />
				</cewolf:gradientpaint>
