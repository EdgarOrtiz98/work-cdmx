...
%>
<%
	boolean bExistenTD = false;
	bExistenTD = ActualizaReportes.getExistenRTD(BUsuario.getIdArea());
...
<LINK href="../css/menu.css" rel="stylesheet"
	type="text/css">
<TITLE>Asuntos por Tipo de Documento</TITLE>
<SCRIPT language="JavaScript" src="../js/GeneralFunctions.js"></SCRIPT>
<script type="text/javascript">
<!--
	function cambio(o, t){
		doc = document.viewRTDocto;
...
<FORM name="viewRTDocto" action="ViewTipoDocto.jsp" method="post">
...
<tr valign="top">
	<td width="43%">
		...
		<a href="ReporteTDocto.jsp" title="Genera Reporte">
	...
	<font face="verdana" size="4">Asuntos por Tipo de Documento</font>
	</td>
</tr>
</table>
...
<TABLE WIDTH='100%' BORDER=0>
	...
	<TR>
		...
		<%	numRegistros = ActualizaReportes.getReportesPorID(BUsuario.getIdArea(),strOrden,strTipo).length;
			if (numRegistros>0){ %>
			<!-- &nbsp;&nbsp;&nbsp;&nbsp;
	...
	<%	String[][] sql = ActualizaReportes.getReportesPorID(BUsuario.getIdArea(),strOrden,strTipo);
	...
	<TR <%if(par(ix+1)==true){%><%}else{%>bgcolor="#f6f6f6"<%}%>>
		<TD WIDTH='15%' align="center">
			...
			<%}%>
			<A href="ReporteTDocto.jsp?id_rep=<%=campo1%>&retURI=<%=com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas)%>">
				<%=campo1%>
			</A>
			</font>
		</TD>
	...
	<% }else{ %>
	<TR>
		<TD align="center" width="100%" colspan="3"><FONT SIZE="3" COLOR="000000" FACE="Arial"><b>*** No existen reportes generados ***</b></FONT></TD>
	</TR>
	<% } %>
	</TBODY>
</TABLE>
