...
<TBODY>
	<TR valign="top">
		<TD width="43%">
			...
			<A href="ExpedienteArch.jsp?retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>">
				<IMG height="26" title="Agregar Expediente" src="../Imagenes/nuevo1.gif" width="27" border="0"></A>
				<FONT face="Tahoma" size="2">
				</FONT>
				<A href="javascript:Borrar()">
				<IMG border="0" title="Borrar Expediente" src="../Imagenes/borrar1.gif" width="30" height="27">
				</A>
		</TD>
...
<TBODY>
	...
	<TR vAlign="middle" <%if(par(t)==true){%><%}else{%>bgcolor="#f6f6f6"<%}%>>
		<TD width="30%">
		    ...
		    <A href="ExpedienteArch.jsp?id_sub=<%= campo1 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>"><%=campo4%></A>
    		</FONT>
	   	</TD> 
		...
		<TD width="25%" align="center">
			<FONT face=Arial color=#000080 size=1>
			<A title="<%=campo3%>"> <script>document.write(trunc('<%=campo3%>','Asunto_HD3'));</script> </A>
			</FONT>
		</TD>
		<TD width="15%" align="center">
			<FONT face=Arial color=#000080 size=1>
