...
/**
 * Clase para generar graficas 3D de Estatus Terminado
 * 
 * @author Meve Soluciones S.A. de C.V.
 */

public class BeanPlanChartEstatusTerminado implements DatasetProducer{
     ...
     * 
     */
    public BeanPlanChartEstatusTerminado(String[][] strDocumentos){
