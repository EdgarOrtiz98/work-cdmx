...
public class _SubFondoView extends com.orionserver.http.OrionHttpJspPage {
    ...
    */
    ...
    try {
      ...
      out.write(__oracle_jsp_text[7]);
      	...
      	bExiste					=	ActualizaSubfondo.getExisteSub();	
      
      	if(strAccion!=null && strAccion.trim().length()>0 && strAccion.equals("borrar"))
      	{
      		bOperacion	=	ActualizaSubfondo.getDeleteSub(strIds_Borrar);	
      	}
      ...
      out.write(__oracle_jsp_text[10]);
      {
        ...
        __jsp_taghandler_1.setDatos(ActualizaSubfondo.getDatosSubFondo(strOrden, strTipo));
  ...
  static {
    ...
    "\" name=\"Borrar\">\n    \t\t<FONT face=Arial color=#000080 size=1>\n\t\t    <A href=\"Subfondo.jsp?id_sub=".toCharArray();
