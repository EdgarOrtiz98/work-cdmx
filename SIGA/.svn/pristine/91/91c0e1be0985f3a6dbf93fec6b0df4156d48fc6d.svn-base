...
<%
	...
	bExistenTD = ActualizaReportes.getExistenRTiempos(BUsuario.getIdArea());
...
<LINK href="../css/menu.css" rel="stylesheet"
	type="text/css">
<TITLE>Tiempo de Solución al Documento</TITLE>
<SCRIPT language="JavaScript" src="../js/GeneralFunctions.js"></SCRIPT>
<script type="text/javascript">
<!--
	function cambio(o, t){
		doc = document.viewTiempo;
...
<FORM name="viewTiempo" action="ViewTiempos.jsp" method="post">
...
<tr valign="top">
	<td width="43%">
		...
		<a href="ReporteTiempos.jsp" title="Genera Reporte">
	...
	<font face="verdana" size="4">Asuntos por Tiempo de Respuesta</font>
	</td>
</tr>
</table>
...
<TABLE WIDTH='100%' BORDER=0>
	...
	<TR>
		...
		<%	numRegistros = ActualizaReportes.getReportesPorTiempos(BUsuario.getIdArea(),strOrden,strTipo).length;
			if (numRegistros>0){ %>
			<!-- &nbsp;&nbsp;&nbsp;&nbsp;
	...
	<%	String[][] sql = ActualizaReportes.getReportesPorTiempos(BUsuario.getIdArea(),strOrden,strTipo);
	...
	<TR <%if(par(ix+1)==true){%><%}else{%>bgcolor="#f6f6f6"<%}%>>
		<TD WIDTH='15%' align="center">
			...
			<%}%>
			<A href="ReporteTiempos.jsp?id_rep=<%=campo1%>&retURI=<%=com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas)%>">
				<%=campo1%>
			</A>
			</font>
		</TD>
