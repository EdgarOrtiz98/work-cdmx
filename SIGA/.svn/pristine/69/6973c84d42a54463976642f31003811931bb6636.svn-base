...
public class _RazonesRechazoView extends com.orionserver.http.OrionHttpJspPage {
  ...
  static {
    ...
    "\"\n\t\t\t\t\t\tname=\"Borrar\"><FONT face=Arial color=#000080 size=1>\n\t\t\t\t\t\t<A href=\"RazonesRechazo.jsp?accion=consultar&Razon_IdRazon=".toCharArray();
