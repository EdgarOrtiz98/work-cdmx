...
public class Report extends HttpServlet implements Servlet {
    
    private String strIdSolicitud="";
	...
	protected void doGet(HttpServletRequest arg0, HttpServletResponse arg1) throws ServletException, IOException {
	    ...
	    strIdSolicitud = (arg0.getParameter("id_sol")==null)?"":arg0.getParameter("id_sol");
		Connection con=null;
		try {
			...
			File reportFile = new File(context.getRealPath("/Reportes/ReportUCT.jasper"));
			Map parameters = new HashMap();    
			parameters.put("SOLICITUD_ID", strIdSolicitud);
