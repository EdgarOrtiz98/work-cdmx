...
public class _PortalTerminado extends com.orionserver.http.OrionHttpJspPage {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    try {
      ...
      out.print(strIdsAsiste[y][0]);
      out.write(__oracle_jsp_text[25]);
      out.print((bMostrar)?"collapse.gif":"expand.gif");
      out.write(__oracle_jsp_text[26]);
      out.print( ActualizaUsuario.NombreUsuario(strIdsAsiste[y][0]) );
      out.write(__oracle_jsp_text[27]);
      out.print( ActualizaUsuario.NombrePuesto(strIdsAsiste[y][0]) );
      ...
      out.print(Utilerias.formatearFechas(usuario15));
  ...
  private static final char __oracle_jsp_text[][]=new char[205][];
  static {
    try {
    __oracle_jsp_text[0] = 
    ...
    "\n\t\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;\n\t\t\t\t\t<A href=\"../ReporteAsuntoExcel?tip=inst_terminado_01&id_remitente=".toCharArray();
