...
<%
	...
	if(strAccion != null && strAccion.equals("guardar"))
	{
		...
		String strTipoRep = "5";
		String strTitulo	=	"";
		String strReporte[][]  =	ActualizaReportes.getReportePorAsuntos(strInicio, strFin, BUsuario.getIdArea());
		...
		try{
			response.sendRedirect("ViewTipoAsunto.jsp");
		}catch(java.io.IOException io){
...
<LINK href="../css/menu.css" rel="stylesheet"
	type="text/css">
<TITLE>Reporte por Tipo de Asuntos</TITLE>
...
<FORM name="reporteTA" action="ReporteTAsunto.jsp" method="post"><INPUT
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr valign="top">
		<td width="144"><% if(strIdReporte == null && (BUsuario.getSupervisor())){ %>
			<A href="ViewTipoAsunto.jsp" title="Regresar"> <IMG src="../Imagenes/NavLeft.gif" border="0"></A> &nbsp;&nbsp;&nbsp;
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr valign="top">
		...
		<td width="108"><a onclick="window.open('../RporTipDocto?id_rep=<%=strIdReporte%>&tip=AnalisisPorTipoAsunto&tit=<%=strDatosReportes[0][0]%>');">
			<IMG border="0" src="../Imagenes/ic_pdf.gif" title="Exportar a PDF"></a></td>
		<td width="144"><a onclick="window.open('../ReportExcel?id_rep=<%=strIdReporte%>&tip=AnalisisPorTipoAsuntoExcel&tit=<%=strDatosReportes[0][0]%>');">
...
<table border="1">
	<tr valign="top">
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr valign="top">
				<td width="410"><b><font size="2" color="#FFFFFF" face="Arial"><%=ActualizaArea.NombreArea(BUsuario.getIdArea())%><BR><%=strDatosReportes[0][0]%></font></b>
				</td>
				<td width="32">
		...
		<TABLE BORDER=1 width="100%">
			<TR VALIGN=top align="center">
				<TD WIDTH="40%" BGCOLOR="002060"><FONT SIZE=2 COLOR="FFFFFF"
					FACE="Arial">Tipos de Asunto</FONT></TD>
	...
	<TBODY>
		<TR>
			<TD><cewolf:chart id="horizontalBarChart3D"
				title="Grafica por numero de Tipo de Asuntos" type="horizontalBar3D"
				xaxislabel="Tipos de Asunto" yaxislabel="Totales">
		...
		<TR>
			<TD><cewolf:chart id="pieChart"
				title="Grafica por porcentajes de Tipo de Asuntos" type="pie">
				<cewolf:gradientpaint>
					<cewolf:point x="0" y="0" color="#FFFFFF" />
					<cewolf:point x="300" y="0" color="#DDDDFF" />
				</cewolf:gradientpaint>
