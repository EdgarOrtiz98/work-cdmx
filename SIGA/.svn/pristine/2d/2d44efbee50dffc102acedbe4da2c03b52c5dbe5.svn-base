...
public class _ReporteRemitente extends com.orionserver.http.OrionHttpJspPage {
    ...
    try {
      ...
      out.write(__oracle_jsp_text[5]);
      	...
      	if(strAccion != null && strAccion.equals("guardar"))
      	{
      		...
      		i			=	iReporte + 1;
      		String strTipoRep = "1"; 
      		String strReporte[][]  =	ActualizaReportes.getReportePorRemitente(strInicio, strFin, BUsuario.getIdArea());
      		...
      		try{
      			response.sendRedirect("ViewRemitente.jsp");
      		}catch(java.io.IOException io){
      ...
      out.write(__oracle_jsp_text[23]);
       numAsuntos += strDatosReportes[y][3]+","; 
      out.write(__oracle_jsp_text[24]);
      out.print(strDatosReportes[y][4]);
      out.write(__oracle_jsp_text[25]);
       porcentaje += strDatosReportes[y][4]+","; 
      ...
      out.write(__oracle_jsp_text[27]);
      {
        ...
        __jsp_taghandler_1.setTitle("Grafica por No. Asuntos por Remitentes Externos");
        __jsp_taghandler_1.setXaxislabel("Remitentes Externos");
      ...
      out.write(__oracle_jsp_text[37]);
      {
        ...
        __jsp_taghandler_8.setTitle("Grafica de Porcentaje de Asuntos por Remitentes Externos");
  ...
  static {
    ...
    "&tip=AnalisisPorRemitente&tit=".toCharArray();
    ...
    "&tip=AnalisisPorRemitenteExcel&tit=".toCharArray();
