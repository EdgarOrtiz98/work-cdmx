...
public class _SerieArchview extends com.orionserver.http.OrionHttpJspPage {
    ...
    */
    ...
    try {
      ...
      out.write(__oracle_jsp_text[13]);
      {
        ...
        __jsp_taghandler_1.setDatos(ActualizaExpArchivado.getDatosSerie(strOrden, strTipo));
  ...
  static {
    ...
    "\" name=\"Borrar\">\n    \t\t<FONT face=Arial color=#000080 size=1>\n\t\t    <A href=\"SerieArch.jsp?id_sub=".toCharArray();
