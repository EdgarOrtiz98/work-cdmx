...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="com.meve.sigma.beans.*, com.meve.sigma.reportes.*,de.laures.cewolf.*,
			com.meve.sigma.util.*,com.meve.sigma.actualiza.*"%>
<%
...
<%
	...
	String strDatosReportes[][] = new String[1][3];
	...
	if(strAccion != null && strAccion.equals("guardar"))
	{
		...
		String strTipoRep = "8";
		String strTitulo	=	""; 
		String strReporte[][]  =	ActualizaReportes.getReportePorFechaCaptura(strInicio, strFin, BUsuario.getIdArea());
		strTitulo 	=	"Reporte Generado del "+strInicio+" al "+strFin;
		bInsertar	=	ActualizaReportes.insertarPorFechaCap(i, strReporte, strTipoRep, 
															strFecha, strTitulo, BUsuario.getIdArea());
		try{
			response.sendRedirect("ViewPorFecha.jsp");
		}catch(java.io.IOException io){
	...
	{
		strDatosReportes = ActualizaReportes.getDatosReportesPorFechaCap(strIdReporte);
	}
...
<TITLE>Reportes Por Fecha de Recepción</TITLE>
...
<FORM name="reportePFCap" action="ReportePorFecha.jsp" method="post"><INPUT
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr valign="top">
		<td width="144"><% if(strIdReporte == null && (BUsuario.getSupervisor())){ %>
			<A href="ViewPorFecha.jsp" title="Regresar"> <IMG src="../Imagenes/NavLeft.gif" border="0"></A> &nbsp;&nbsp;&nbsp;
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr valign="top">
				...
				<td width="173"><INPUT name="inicioR" value="" onfocus="blur();"
					onclick="document.forms.reportePFCap.inicioR.value=''" class="blue100">
				...
				<td width="174"><INPUT name="finR" value="" onfocus="blur();"
					onclick="document.forms.reportePFCap.finR.value=''" class="blue100"> <A><IMG
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr valign="top">
		...
		<td width="108"><a onclick="window.open('../RporTipDocto?id_rep=<%=strIdReporte%>&tip=AnalisisPorFecha&tit=<%=strDatosReportes[0][0]%>');">
			<IMG border="0" src="../Imagenes/ic_pdf.gif" title="Exportar a PDF"></a></td>
		<td width="144"><a onclick="window.open('../ReportExcel?id_rep=<%=strIdReporte%>&tip=AnalisisPorFechaExcel&tit=<%=strDatosReportes[0][0]%>');">
...
<table border="1">
	<tr valign="top">
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr valign="top">
				<td width="310"><b><font size="2" color="#FFFFFF" face="Arial"><%=ActualizaArea.NombreArea(BUsuario.getIdArea())%><BR><%=strDatosReportes[0][0]%></font></b>
				</td>
				<td width="132">
		...
		<TABLE BORDER=1 width="100%">
			<TR VALIGN=top align="center">
				<TD WIDTH="40%" BGCOLOR="002060"><FONT SIZE=2 COLOR="FFFFFF"
					FACE="Arial">Fecha de Recepción</FONT></TD>
				<TD WIDTH="60%" BGCOLOR="002060"><FONT SIZE=2 COLOR="FFFFFF"
					FACE="Arial">No. Asuntos</FONT></TD>
			</TR>
			<% for(int y=0;y<strDatosReportes.length;y++){ %>
			<TR VALIGN=top>
				<TD WIDTH="40%" align="center"><FONT SIZE=2 FACE="Arial"><%=strDatosReportes[y][2]%></FONT>
				</TD>
				<TD WIDTH="60%" align="center"><FONT SIZE=2 FACE="Arial"><%=strDatosReportes[y][3]%></FONT>
				</TD>
			</TR>
			<% } %>
		</TABLE>
	...
	<TBODY>
		<TR>
			<TD><cewolf:chart id="horizontalBarChart3D"
				title="Grafica de Asuntos por Fechas de Recepción" type="horizontalBar3D"
				xaxislabel="Fechas de Recepción" yaxislabel="Totales">
				...
				<cewolf:img chartid="horizontalBarChart3D" renderer="/cewolf" width="850" height="800"/>
			</TD>
		</TR>
	</TBODY>
</TABLE>
