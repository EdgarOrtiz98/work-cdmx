...
public class _ViewAsuntoRemitido extends com.orionserver.http.OrionHttpJspPage {
  ...
  static {
    ...
    "\n\t\t\t<A href=\"ReporteRemitido.jsp?id_rep=".toCharArray();
