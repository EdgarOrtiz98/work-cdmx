...
public class _ReporteRemitenteI extends com.orionserver.http.OrionHttpJspPage {
    ...
    */
    ...
    try {
      ...
      out.write(__oracle_jsp_text[27]);
      {
        ...
        __jsp_taghandler_1.setTitle("Grafica por No. Asuntos por Remitentes Internos");
        __jsp_taghandler_1.setXaxislabel("Remitentes Internos");
      ...
      out.write(__oracle_jsp_text[37]);
      {
        ...
        __jsp_taghandler_8.setTitle("Grafica de Porcentaje de Asuntos por Remitentes Internos");
  ...
  static {
    ...
    "&tip=AnalisisPorRemitenteI&tit=".toCharArray();
    ...
    "&tip=AnalisisPorRemitenteExcelI&tit=".toCharArray();
