...
<%
	...
	if(strAccion != null && strAccion.equals("guardar"))
	{
		...
		String strTipoRep = "0";
		String strTitulo	=	""; 
		String strReporte[][]  =	ActualizaReportes.getReporte(strInicio, strFin, BUsuario.getIdArea());
		...
		bInsertar	=	ActualizaReportes.InsertarAsunto(i, strReporte, strTipoRep, 
														strFecha, count, strTitulo, BUsuario.getIdArea());
		try{
			response.sendRedirect("ViewTipoDocto.jsp");
		}catch(java.io.IOException io){
...
<TITLE>Reporte por Tipo de Documento</TITLE>
...
<FORM name="reporteTD" action="ReporteTDocto.jsp" method="post"><INPUT
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr valign="top">
		<td width="144"><% if(strIdReporte == null && (BUsuario.getSupervisor())){ %>
			<A href="ViewTipoDocto.jsp" title="Regresar"> <IMG src="../Imagenes/NavLeft.gif" border="0"></A> &nbsp;&nbsp;&nbsp;
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr valign="top">
				...
				<td width="173"><INPUT name="inicioR" value="" onfocus="blur();"
					onclick="document.forms.reporteTD.inicioR.value=''" class="blue100">
				...
				<td width="174"><INPUT name="finR" value="" onfocus="blur();"
					onclick="document.forms.reporteTD.finR.value=''" class="blue100"> <A><IMG
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr valign="top">
		...
		<td width="108"><a onclick="window.open('../RporTipDocto?id_rep=<%=strIdReporte%>&tip=AnalisisPorTipoDocto&tit=<%=strDatosReportes[0][0]%>');">
			<IMG border="0" src="../Imagenes/ic_pdf.gif" title="Exportar a PDF"></a></td>
		<td width="144"><a onclick="window.open('../ReportExcel?id_rep=<%=strIdReporte%>&tip=AnalisisPorTipoDoctoExcel&tit=<%=strDatosReportes[0][0]%>');">
		...
		<TABLE BORDER=1 width="100%">
			<TR VALIGN=top align="center">
				<TD WIDTH="40%" BGCOLOR="002060"><FONT SIZE=2 COLOR="FFFFFF"
					FACE="Arial">Tipos de Documentos</FONT></TD>
			...
			<TR VALIGN=top>
				<TD WIDTH="40%"><FONT SIZE=2 FACE="Arial"><%=strDatosReportes[y][2]%></FONT>
				</TD>
				<TD WIDTH="30%" align="center"><FONT SIZE=2 FACE="Arial"><%=strDatosReportes[y][3]%></FONT>
				</TD>
				<TD WIDTH="30%" align="center"><FONT SIZE=2 FACE="Arial"><%=strDatosReportes[y][4]%>%</FONT>
				</TD>
			</TR>
			<% } %>
		</TABLE>
	...
	<TBODY>
		<TR>
			<TD><cewolf:chart id="horizontalBarChart3D"
				title="Grafica por numero de Tipo de Documentos" type="horizontalBar3D"
				xaxislabel="Tipos de Documento" yaxislabel="Totales">
		...
		<TR>
			<TD><cewolf:chart id="pieChart"
				title="Grafica por porcentaje de Tipo de Documentos" type="pie">
				<cewolf:gradientpaint>
					<cewolf:point x="0" y="0" color="#FFFFFF" />
					<cewolf:point x="300" y="0" color="#DDDDFF" />
				</cewolf:gradientpaint>
