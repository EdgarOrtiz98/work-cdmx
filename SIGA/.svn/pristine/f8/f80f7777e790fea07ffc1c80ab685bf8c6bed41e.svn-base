...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="com.meve.sigma.beans.*,com.meve.sigma.actualiza.*,
		com.meve.sigma.util.*,com.meve.sigma.reportes.*,
		java.sql.Date"
%> 
...
<SCRIPT language=JavaScript type=text/javascript>
	...
	function Reasignar(){
		location.assign('Reasignar.jsp?id_ins=<%=strIdInstruccion%>&id_asunto=<%=strIdAsunto%>&ava=<%=strAvance%>&usr_ori=<%=strUsuarioOriginal%>&estValidacion=<%= strEstValidacion %>&retURI=<%= Utilerias.codificaPostHTML("InstruccionTurnada.jsp?id_ins="+strIdInstruccion+"&ih="+strIH+"&retURI="+Utilerias.codificaPostHTML(retURI)) %>');
	}
	function Delegar(){
	...
	function cargaApplet(){
		location.assign('VisualizaInstrucciones.jsp?idAsunto=<%=strIdAsunto%>&Instruccion=<%= strIdInstruccion %>&Url=<%=URL%>');
	}
...
<INPUT name="dif" value="<%=strDif%>" type="hidden">
		...
		<c:choose>
			<c:when test='${BEscritura.value}'>
				...
				<td width="40">
					...
					<IMG border="0" src="../Imagenes/elim_delg_multiple.gif" title="Deshabilitar Delegación Multiple" name="Habilitar2"></A>
				</td>
				<%}%>
				<%}%>
			</c:when>
			...
			<c:when test='${BEscritura.value}'>
				<TD width="80">
					...
					<IMG border="0" src="../Imagenes/CrearRuta.gif"
						title="Crear ruta" name="CrearRuta"></A>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;<A onclick="turnar1()" 
						...
						onMouseOut="document.Turnar.src='../Imagenes/Turnar.gif';"><IMG border="0" src="../Imagenes/Turnar.gif" title="Turnar" name="Turnar"></A>
					<%}else if(estatusHijos.length() > 0 && sumEstatus > 0){%>
					<A onclick="if(botonBandera){botonBandera=false; cargaAppletMul();}"
						onMouseOver="document.CrearRuta.src='../Imagenes/CrearRuta2.gif';"
						onMouseOut="document.CrearRuta.src='../Imagenes/CrearRuta.gif';">
					<IMG border="0" src="../Imagenes/CrearRuta.gif"
						title="Editar Ruta" name="CrearRuta">
					</A>
		...
		<c:choose>
			<c:when test='${BEscritura.value}'>
				<A onclick="if(botonBandera){botonBandera=false; cargaApplet();}"
						...
						onMouseOut="document.CrearRuta.src='../Imagenes/CrearRuta.gif';">
					<IMG border="0" src="../Imagenes/CrearRuta.gif"
						title="Editar Ruta" name="CrearRuta"></A>
			</c:when>
			<c:otherwise>
				<td width="40">&nbsp;</td>
			</c:otherwise>
	...
	<% }else{ %>
		...
		<c:choose>
			<c:when test='${BEscritura.value}'>
				...
				%>
				<TD width="80">
					<%--Carga Applet1 para ver ruta de la ventanilla 2 Hola--%>
					<DIV align="left">
					<A onclick="if(botonBandera){botonBandera=false; cargaApplet();}" 
						onMouseOver="document.CrearRuta.src='../Imagenes/CrearRuta2.gif';"
						onMouseOut="document.CrearRuta.src='../Imagenes/CrearRuta.gif';">
					<IMG border="0" src="../Imagenes/CrearRuta.gif" title="Ver Ruta de Atención" name="CrearRuta"></A>
					&nbsp;&nbsp;&nbsp;&nbsp;<%if(!bVacios){%><A onclick="if(botonBandera){botonBandera=false; turnar1();}" 
						onMouseOver="document.Turnar.src='../Imagenes/Turnar2.gif';"
						onMouseOut="document.Turnar.src='../Imagenes/Turnar.gif';"><IMG border="0" src="../Imagenes/Turnar.gif" title="Turnar" name="Turnar"></A><%}%>
					</DIV>
				</TD>
       ...
       <c:when test='${BEscrituraTur.value}'>
        <td width="40" valign="top">
         <a onclick="+Utilerias.codificaPostHTML(retURI)) %>');}"
            onmouseover="false;"
            turnaronmouseoverdocument.habilitar2.src='../Imagenes/elim_delg_multiple.gif&apos;;">      <IMG border="0" src="../Imagenes/elim_delg_multiple.gif" title="Deshabilitar'
            delegación="false;"
            ...
            agregarcomentarioonmouseoverdocument.comentario.src='../Imagenes/Comentario.gif&apos;;">      <IMG border="0" src="../Imagenes/Comentario.gif" title="Crear'
            un="false;"
            rutanamecrearrutaa--inputtypebuttononclickcargaappletvaluecrear="false;"
            cargaappletmulonmouseoverdocument.crearruta.src='../Imagenes/CrearRuta.gif&apos;;">      <IMG border="0" src="../Imagenes/CrearRuta.gif" title="Ver'
            ruta="Ruta" de="de"
            ...
            terminarrechazadaonmouseoverdocument.terrechazada.src='../Imagenes/Responder.gif&apos;;">      <IMG border="0" src="../Imagenes/Responder.gif" title="Terminar'
		...
		<c:choose>
			<c:when test='${BEscritura.value}'>
				...
				<A onclick="if(botonBandera){botonBandera=false; cargaApplet();}"
					...
					onMouseOut="document.CrearRuta.src='../Imagenes/CrearRuta.gif';">
				<IMG border="0" src="../Imagenes/CrearRuta.gif"
					title="Editar Ruta" name="CrearRuta"></A><%if(ActualizaInstrucciones.getTieneHijosPorTurnar(strIdInstruccion)){%>&nbsp;&nbsp;<A onclick="if(botonBandera){botonBandera=false; turnar1();}" onMouseOver="document.Turnar.src='../Imagenes/Turnar2.gif';"
						onMouseOut="document.Turnar.src='../Imagenes/Turnar.gif';"><IMG border="0" src="../Imagenes/Turnar.gif" title="Turnar" name="Turnar"></A>
				<%}%>
				<%}%>
				</td>
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr valign="top">
		...
		<td align="right" width="394">
			<font size="2" color="#00204f" face="Verdana">Folio:&nbsp;<b><%=strFolioTurnado%></b></font><BR>
			<%if(!strBandera1.equals("0")){%>
			<font size="2" color="#00204f" face="Verdana">Folio de Control:&nbsp;<b><%=strFolioEntrada%></b></font><BR>
			<%}%>
		</td>
	</tr>
	<tr valign="top">
...
<table border="0" cellspacing="0" cellpadding="0">
	...
	<tr valign="top">
		...
		<td width="">
			<font size="2" face="Arial"><%= strVerDocto %>
			<INPUT type="hidden" name="verDoctoHdn" value="<%=strVerDocto%>"></font>
			<% if(strAcceso.equals("1")){ %>
				<%if(strPadre.length()!=0){%>
				<A href="InstruccionTurnada.jsp?id_ins=<%= strPadre %>&ih=<%=strIdInstruccion%>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?id_ins="+strIdInstruccion+"&ih="+strIH+"&retURI="+com.meve.sigma.util.Utilerias.codificaPostHTML(retURI)) %>">
				<IMG SRC='../Imagenes/type_document.gif' BORDER=0> </A>
				<%}else{%>
				<A href="AsuntoTurnado.jsp?id_asunto=<%= strIdAsunto %>&per=1&inst=1&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?id_ins="+strIdInstruccion+"&ih="+strIH+"&retURI="+com.meve.sigma.util.Utilerias.codificaPostHTML(retURI)) %>">
				<IMG SRC='../Imagenes/type_document.gif' BORDER=0> </A>
				<%}%>
			<%}%>
		</td>
...
<TABLE cellspacing="0" cellpadding="0" width="100%" border="0">
	<TBODY>
		...
		<TR valign="top">
			<TD width="100%" bgcolor="#004080" colspan="4"><IMG height="2" title=""
				...
				<TBODY>
					...
					<meve_front:ListaDatos
						...
						<TR valign="top" <%if(par(t)==true){%><%}else{%>bgcolor="#f6f6f6"<%}%>>
							...
							<TD>
							<DIV align="center"><FONT face="Verdana" color="#000000" size="1"><%= campo13 %></FONT></DIV>
							</TD>
							<TD>
							<DIV align="center">
							...
							<TD>
							<DIV align="center"><FONT face="Verdana" color="#000000" size="1"><%= ActualizaArea.NombreArea(campo10) %></FONT>
							</DIV>
							</TD>
							<TD>
							<DIV align="center"><FONT face="Verdana" color="#000000" size="1">
							<% if(campo3.length() == 0){ %> <%= campo8 %> <% }else{ %> <%= ActualizaInst.getNombreInstruccion1(campo3) %>
							<% } %> </FONT></DIV>
							</TD>
							<TD>
							<DIV align="center"><FONT face="Verdana" color="#000000" size="1">
							<% if(campo5.length() == 0){ %>- <% }else{ %> <%= Utilerias.formatearFechas(campo4) %>
							<% } %> </FONT></DIV>
							</TD>
							<TD>
							<DIV align="center"><FONT face="Verdana" color="#000000" size="1">
							<% if(campo5.length() == 0){ %>- <% }else{ %> <%= Utilerias.formatearFechas(campo5) %>
							<% } %> </FONT></DIV>
							</TD>
							<TD>
							<DIV align="center"><FONT face="Verdana" color="#000000" size="1"><%= campo14 %></FONT>
							</DIV>
							</TD>
							<TD>
							<DIV align="center"><FONT face="Verdana" color="#000000" size="1">
							...
							<TD>
							<DIV align="center"><FONT face="Verdana" color="#000000" size="1"><%= campo6 %>%</FONT>
							</DIV>
							</TD>
							<TD>
							<DIV align="center"><FONT face="Verdana" color="#000000" size="1">
							<% if(campo7.equals("1")){ %> <% if(campo17.equals("0")){ %> <A
								href="InstruccionHija.jsp?id_ins=<%= campo12 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?id_ins="+strIdInstruccion+"&ih="+strIH+"&retURI="+com.meve.sigma.util.Utilerias.codificaPostHTML(retURI)) %>"> <U>Notificado</U></A>
							<% }else if(campo17.equals("1")){ %> <A
								href="InstruccionTurnada.jsp?id_ins=<%= campo12 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?id_ins="+strIdInstruccion+"&ih="+strIH+"&retURI="+com.meve.sigma.util.Utilerias.codificaPostHTML(retURI)) %>"> <U>Notificado</U></A>
							<% } %> <% }else if(campo7.equals("2")){ %> <% if(campo17.equals("0")){ %>
							<A href="InstruccionHija.jsp?id_ins=<%= campo12 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?id_ins="+strIdInstruccion+"&ih="+strIH+"&retURI="+com.meve.sigma.util.Utilerias.codificaPostHTML(retURI)) %>"> <U>En
							Proceso</U></A> <% }else if(campo17.equals("1")){ %> <A
								href="InstruccionTurnada.jsp?id_ins=<%= campo12 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?id_ins="+strIdInstruccion+"&ih="+strIH+"&retURI="+com.meve.sigma.util.Utilerias.codificaPostHTML(retURI)) %>"> <U>En
							Proceso</U></A> <% } %> <% }else if(campo7.equals("3")){ %> <A
								href="InstruccionHija.jsp?id_ins=<%= campo12 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?id_ins="+strIdInstruccion+"&ih="+strIH+"&retURI="+com.meve.sigma.util.Utilerias.codificaPostHTML(retURI)) %>"> <U>Rechazada</U></A>
							<% }else if(campo7.equals("4")){ %> <% if(campo17.equals("0")){ %>
							<A href="InstruccionHija.jsp?id_ins=<%= campo12 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?id_ins="+strIdInstruccion+"&ih="+strIH+"&retURI="+com.meve.sigma.util.Utilerias.codificaPostHTML(retURI)) %>"> <U>Terminada</U></A>
							<% }else if(campo17.equals("1")){ %> <A
								href="InstruccionTurnada.jsp?id_ins=<%= campo12 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?id_ins="+strIdInstruccion+"&ih="+strIH+"&retURI="+com.meve.sigma.util.Utilerias.codificaPostHTML(retURI)) %>"> <U>Terminada</U></A>
							<% } %> <% } %></FONT></DIV>
							</TD>
							<TD>
							<%if("1".equals(campo19)){%>
...
<table border="0" cellspacing="0" cellpadding="0" width="863">
	...
	<tr valign="top">
		...
		<td width="100%" colspan="4"><font size="1" color="#004080"
			...
			<a href="Responder.jsp?id_his=<%= campo1 %>&estValidacion=<%= strEstValidacion %>&retURI=<%= Utilerias.codificaPostHTML("InstruccionTurnada.jsp?id_ins="+strIdInstruccion+"&ih="+strIH+"&retURI="+Utilerias.codificaPostHTML(retURI)) %>"> <font size="1"
