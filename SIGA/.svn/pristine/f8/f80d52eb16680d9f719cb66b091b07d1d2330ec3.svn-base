...
public class _TipoAsuntoView extends com.orionserver.http.OrionHttpJspPage {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    try {
      ...
      out.print(ActualizaTipoAsunto.getNombreTipoAsunto((String)vTiene.get(i)));
      out.write(__oracle_jsp_text[18]);
      out.print(Utilerias.recortaString(ActualizaTipoAsunto.getNombreTipoAsunto((String)vTiene.get(i)),80));
  ...
  static {
    ...
    "\n<TABLE cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" border=\"0\">\n\t<TBODY>\n\t\t<TR valign=\"top\">\n\t\t\t<TD width=\"40%\"><A href=\"TipoAsunto.jsp?retURI=".toCharArray();
    ...
    "\"\n\t\t\t\t\t\tname=\"Borrar\"><FONT face=Arial color=#000080 size=1>\n\t\t\t\t\t\t<A href=\"TipoAsunto.jsp?accion=consultar&TipoAsunto_idTipoAsunto=".toCharArray();
    ...
    "','Asunto_HD'));</script></A>\n\t\t\t\t\t</FONT></td>\n\t\t\t\t\t<td width=\"50%\" align=\"center\" valign=\"middle\"><a title=\"".toCharArray();
