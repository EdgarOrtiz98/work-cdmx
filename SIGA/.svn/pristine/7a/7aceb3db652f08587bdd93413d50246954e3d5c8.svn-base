...
/**
 * Bean para exportar los Reportes de Asuntos de Tiempo Real
 *
 * @author Meve Soluciones S.A. de C.V.
 */
public class BeanTimeRealChart implements DatasetProducer{
    
    private String[][] strDocumentos = null;
    
    public final String LABEL = "Tipos de Documentos";
     ...
     * 
     */
    public BeanTimeRealChart(String[][] strDocumentos){
    ...
    public Object produceDataset(Map params) {
        ...
        final String[] categories = {"Mas Corto", "Mas Largo", "Promedio"};
    ...
    static 
    {
        log = LogFactory.getLog(BeanTimeRealChart.class);
    }
