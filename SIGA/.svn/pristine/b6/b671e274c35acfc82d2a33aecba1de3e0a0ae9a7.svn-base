...
public class _TurnadoPorArea extends com.orionserver.http.OrionHttpJspPage {
    ...
    */
    ...
    try {
      ...
      out.write(__oracle_jsp_text[4]);
      	...
      	String[][] strDatos = ActualizaAsunto.AsuntosPorFolioT(BUsuario.getIdArea(),strOrden,strTipo);
  ...
  static {
    ...
    "\n\t\t\t\t</font>\n\t\t\t</td>\n\t\t\t<td align=\"center\" width=\"30%\"><font size=\"1\" color=\"#000080\"\n\t\t\t\tface=\"Arial\"> ".toCharArray();
    ...
    "\n\t<TR>\n\t\t<TD width=\"20%\">\n\t\t<div align=center><FONT face=\"verdana\" size=\"4\">******No Existen Asuntos******</FONT></div>\n\t\t</TD>\n\t</TR>\n\t".toCharArray();
