...
public class SubDirectos {
	 ...
	 */
	public SubDirectos(String[][] sNom, String idArea) {
		sNom1 		= sNom;
		vNom 		= new Vector();
		vNomHtml 	= new Vector();
		...
		vIds 		= new Vector();
		area		= idArea;
		RecorreDocumentos(sNom1, idArea);
		//RecorreAreas(sNom1);
	}
	 ...
	 */
	public SubDirectos(String[][] sNom, String strIdArea, String retURI) {
		sNom1 		= sNom;
		vNom 		= new Vector();
		vNomHtml 	= new Vector();
		vNomHtmlGes	= new Vector();
	 ...
	 */
	public static void RecorreDocumentos(String[][] strValores, String idArea)
    {		
		if (strValores.length > 0){
	        ...
	        for(int i=0; i<strValores.length; i++)
	        {
	            ...
	            if(hijos)
	            {
	               	String strUsuario[][] = ActualizaUsuario.getSubordinadosDirectos(strValores[i][0], idArea);
	               	RecorreDocumentos(strUsuario, idArea);
