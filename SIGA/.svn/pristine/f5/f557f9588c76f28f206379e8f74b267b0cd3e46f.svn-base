...
<TBODY>
	<TR valign="top">
		<TD width="43%">
			...
			<A href="IcddArch.jsp?retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>">
				<IMG height="26" src="../Imagenes/nuevo1.gif" title="Agregar ICDD" width="27" border="0"></A>
				<FONT face="Tahoma" size="2">
				</FONT>
				<A href="javascript:Borrar()">
				<IMG border="0" title="Borrar ICDD" src="../Imagenes/borrar1.gif" width="30" height="27">
				</A>
		</TD>
...
<TBODY>
	...
	<TR vAlign="middle" <%if(par(t)==true){%><%}else{%>bgcolor="#f6f6f6"<%}%>>
		<TD width="15%" align="left">
    		...
    		<A href="IcddArch.jsp?id_sub=<%= campo13 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>" class ="etiquetas" title="<%= ActualizaArea.NombreArea(campo15) %>"><%=campo14%></A>
    		</FONT>
		</TD>
		<TD width="10%" align="center">
    		<FONT face=Arial color=#000080 size=1>
    		<A href="IcddArch.jsp?id_sub=<%= campo13 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>" class ="etiquetas" title= "<%=campo10 %>"><%=campo5%></A>
    		</FONT>
	   	</TD> 
		<TD width="15%" align="center">
			<FONT face=Arial color=#000080 size=1>
    		<A href="IcddArch.jsp?id_sub=<%= campo13 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>" class ="etiquetas" title= "<%=campo9 %>"><%=campo4%></A>
    		</FONT>
		</TD>
		<TD width="15%" align="center">
			<FONT face=Arial color=#000080 size=1>
    		<A href="IcddArch.jsp?id_sub=<%= campo13 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>" class ="etiquetas" title= "<%=campo8 %>"><%=campo3%></A>
    		</FONT>
		</TD>
		<TD width="10%" align="center">
			<FONT face=Arial color=#000080 size=1>
    		<A href="IcddArch.jsp?id_sub=<%= campo13 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>" class ="etiquetas" title= "<%=campo7 %>"><%=campo2%></A>
    		</FONT>
		</TD>
		<TD width="15%" align="center">
			<FONT face=Arial color=#000080 size=1>
    		<A href="IcddArch.jsp?id_sub=<%= campo13 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>" class ="etiquetas" title= "<%=campo6 %>"><%=campo1%></A>
    		</FONT>
		</TD>
		<TD width="10%" align="center">
			<FONT face=Arial color=#000080 size=1>
    		<A class ="etiquetas" ><%=campo11%></A>
    		</FONT>
		</TD>			
		<TD width="10%" align="center">
			<FONT face=Arial color=#000080 size=1>
