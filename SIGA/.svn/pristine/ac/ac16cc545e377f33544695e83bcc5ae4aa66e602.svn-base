...
public class _ReporteTDocto extends com.orionserver.http.OrionHttpJspPage {
    ...
    */
    ...
    try {
      ...
      out.write(__oracle_jsp_text[24]);
      {
        ...
        __jsp_taghandler_1.setTitle("Grafica por numero de Tipo de Documentos");
        __jsp_taghandler_1.setXaxislabel("Tipos de Documento");
      ...
      out.write(__oracle_jsp_text[34]);
      {
        ...
        __jsp_taghandler_8.setTitle("Grafica por porcentaje de Tipo de Documentos");
  ...
  static {
    ...
    "&tip=AnalisisPorTipoDocto&tit=".toCharArray();
    ...
    "&tip=AnalisisPorTipoDoctoExcel&tit=".toCharArray();
    ...
    "\n\t\t\t<TR VALIGN=top>\n\t\t\t\t<TD WIDTH=\"40%\"><FONT SIZE=2 FACE=\"Arial\">".toCharArray();
