...
public class _RecepcionFecha extends com.orionserver.http.OrionHttpJspPage {
    ...
    */
    ...
    try {
      ...
      out.write(__oracle_jsp_text[8]);
      {
        ...
        __jsp_taghandler_1.setDatos(ActualizaAsunto.AsuntosPorFecha());
        ...
        if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
        {
          ...
          do {
            ...
            out.print(Utilerias.formatearFechas(campo1));
            ...
            out.write(__oracle_jsp_text[12]);
            {
              ...
              __jsp_taghandler_2.setDatos(ActualizaAsunto.getFechaAsunto(campo1));
