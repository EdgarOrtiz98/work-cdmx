...
public class _ReporteTAsunto extends com.orionserver.http.OrionHttpJspPage {
    ...
    */
    ...
    try {
      ...
      out.write(__oracle_jsp_text[24]);
      {
        ...
        __jsp_taghandler_1.setTitle("Grafica por numero de Tipo de Asuntos");
        __jsp_taghandler_1.setXaxislabel("Tipos de Asunto");
      ...
      out.write(__oracle_jsp_text[34]);
      {
        ...
        __jsp_taghandler_8.setTitle("Grafica por porcentajes de Tipo de Asuntos");
  ...
  static {
    ...
    "&tip=AnalisisPorTipoAsunto&tit=".toCharArray();
