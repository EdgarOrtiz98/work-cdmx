	...
	<TR>
		<TD width="43%">
			<A href="Expediente.jsp" target="_self">
				<IMG height="26" src="../Imagenes/Nuevo.gif" width="27" border="0" title="Nuevo Expediente"></A>
				<FONT face="Tahoma" size="2">
				</FONT>
				<A href="javascript:Borrar()" target="_self">
				<IMG border="0" src="../Imagenes/borrar2.gif" width="30" height="27" title="Borrar Expedientes"></A>
		</TD>
...
<TBODY>
	...
	<% if(bExiste){ %>
	<meve_front:ListaDatos datos="<%= ActualizaExpediente.getListaExpediente(strOrden, strTipo) %>" campo="campo">
	...
	<TR vAlign=top <%if(par(t)==true){%><%}else{%>bgcolor="#f6f6f6"<%}%>>
		<TD width="50%">
		    ...
		    <A href="Expediente.jsp?id_exp=<%= campo1 %>"><%= campo2 %></A>
    		</FONT>
	   	</TD>
		<TD width="50%" align="center">
			<FONT face=Arial color=#000080 size=1>
