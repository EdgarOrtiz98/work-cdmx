...
public class _ReporteTDest extends com.orionserver.http.OrionHttpJspPage {
    ...
    try {
      ...
      out.write(__oracle_jsp_text[5]);
      	...
      	if(strAccion != null && strAccion.equals("guardar"))
      	{
      		...
      		i			=	iReporte + 1;
      		String strTipoRep = "6"; 
      		String strReporte[][]  =	ActualizaReportes.getReportePorDestinatario(strInicio, strFin, BUsuario.getIdArea());
      		...
      		bInsertar	=	ActualizaReportes.InsertarAsunto(i, strReporte, strTipoRep, strFecha, count, strTitulo, BUsuario.getIdArea());
      		try{
      			response.sendRedirect("ViewDestinatario.jsp");
      		}catch(java.io.IOException io){
      ...
      out.write(__oracle_jsp_text[24]);
      {
        ...
        __jsp_taghandler_1.setTitle("Grafica por No. Asuntos por Ventanilla");
        __jsp_taghandler_1.setXaxislabel("Ventanilla");
      ...
      out.write(__oracle_jsp_text[33]);
      {
        ...
        __jsp_taghandler_7.setWidth(750);
        __jsp_taghandler_7.setHeight(650);
      ...
      out.write(__oracle_jsp_text[34]);
      {
        ...
        __jsp_taghandler_8.setTitle("Grafica de Porcentaje de Asuntos por Ventanilla");
      ...
      out.write(__oracle_jsp_text[43]);
      {
        ...
        __jsp_taghandler_14.setWidth(750);
        __jsp_taghandler_14.setHeight(650);
  ...
  static {
    ...
    "&tip=AnalisisPorDestinatario&tit=".toCharArray();
    ...
    "&tip=AnalisisPorDestinatarioExcel&tit=".toCharArray();
