...
/**
 * Bean para crear un eltiqueta html tipo SELECT
 * @author 	Meve Soluciones
 *
 * @version	1.0
 */
public class CreaCombo extends TagSupport{
	...
	*/
	public int doStartTag()throws JspException{
		try
		{
			...
			out.println(Html.creaSelect(data, name, size, selected, disabled, multiple, classHtml, style, script, textoNoSeleccion, valorNoSeleccion));
			
		}catch(IOException ioE){
			throw new JspException("Error de tipo IO al crear combo: " + ioE);
		}
