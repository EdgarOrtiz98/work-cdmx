...
<%@ page import="com.meve.sigma.beans.*,com.meve.sigma.reportes.*,com.meve.sigma.actualiza.*,java.util.*"%>
<%
...
<TABLE cellspacing="0" cellpadding="0" width="100%" border="0">
	<TBODY>
		<TR>
			<TD width="40%"><A href="Instrucciones.jsp?retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>" target="_self"> <IMG
				height="26" src="../Imagenes/nuevo1.gif" width="27" border="0"
				title="Nueva Instrucción"> </A> <FONT face="Tahoma" size="2"></FONT> <A
				href="javascript:Borrar()" target="_self"><IMG border="0"
				src="../Imagenes/borrar1.gif" width="30" height="27"
				title="Borrar Instrucciones"></A></TD>
			<TD width="50%">
			<DIV align="right">
				<% 
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="70%"><INPUT type=checkbox value="<%=Lista1 %>"
						...
						<A href="Instrucciones.jsp?id_inst=<%=Lista1 %>&retURI=<%= com.meve.sigma.util.Utilerias.codificaPostHTML(strTmp+"?orden="+strOrden+"&tipo="+strTipo+"&contPag="+contPag+"&contligas="+contligas) %>" 
							title="<%=Lista2%>"><script>document.write(trunc('<%=Lista2%>','Asunto_HD'));</script></A>
					</FONT></td>
					<td width="30%" align="center" valign="middle"><A title="<%=Lista3%>"><script>document.write(trunc('<%=Lista3%>','Asunto_HD'));</script></A></td>
				</tr>
			</table>
			</TD>
		</TR>
