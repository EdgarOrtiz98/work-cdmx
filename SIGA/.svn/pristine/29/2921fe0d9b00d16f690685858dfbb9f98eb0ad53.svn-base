...
public class _ViewEstatus extends com.orionserver.http.OrionHttpJspPage {
  ...
  static {
    ...
    "\n\t\t<a href=\"ReporteEstatus.jsp?retURI=".toCharArray();
    ...
    "\n\t\t\t<A href=\"ReporteEstatus.jsp?id_rep=".toCharArray();
