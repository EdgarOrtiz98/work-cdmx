	...
	<TABLE align="center">
		<TBODY>
			...
			<TR valign="top">
				...
				<TD><html:text property="parametroId" size="50"></html:text></TD>
			</TR>
			<TR valign="top">
				<TD width="144">&nbsp;</TD>
				<TD width="192">&nbsp;</TD>
			...
			<TD width="144"><FONT face="Verdana" size="2" color="#004080"><B>Valor:
				...
				<TD>
				<html:text property="parametroValor"  size="50"></html:text>
				</TD>
			</TR>
			<TR valign="top">
				<TD width="144">&nbsp;</TD>
			...
			<TR valign="top">
				...
				<TD colspan="3"><html:text property="parametroDescripcion"  size="50"></html:text>
				</TD>
			</TR>
			<TR>
			<TR valign="top">
